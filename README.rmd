...
6. Edit the individual files ("childs") to edit your sections' content as desired (e.g., `publications.Rmd`).
7. To output the CV to PDF, simply knit `cv.Rmd` (shortcut is Ctr+Shift+K)
