...
- It is possible to import data from other sources automatically (from ORCID, Google Scholar, or another platform), but I have not personally experimented with this yet. More info can be found [here](https://pkg.mitchelloharawild.com/vitae/articles/data.html).
