...
data <- bind_rows(
    ...
    tibble(
    Name = "NYU Faculty of Arts \\& Sciences Postdoctoral Travel Grant Award (USD \\$700)",
    Name_alt = "Bourse de participation aux conférences de la Faculté des Arts \\& Sciences de NYU (USD \\$700)",
    URL = "",
    ...
    Name_alt = "Prix du meilleur article étudiant (UQAM)",
    URL = "",
    Details = "",
    Date = "2024",
    Amount = 200,
...
nice_awards(data, language = language, number = count_everything)
