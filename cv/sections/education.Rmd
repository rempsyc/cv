...
data <- rbind(
  ...
  tibble(
    ...
    details = c(# "GPA: 4.30/4.30",
                "Advisory Committee: 
                                    Stéphane Dandeneau (superviseur), 
                                    Frédérick Philippe,
                                    Simon Grégoire, 
                                    Marina Doucerain, \\&
                                    Bassam Khoury")), 
...
edu_dictionary <- tribble(
  ~English, ~French,
  "Postdoctoral Fellow", "Postdoctorat",
  "Master of Science", "Maitrise",
  "Bachelor of Arts", "Baccalauréat",
  "Social Resilience Lab", "Laboratoire de résilience sociale",
  "Supervisor:", "Superviseur :",
  "Advisory Committee:", "Comité de thèse :",
  "ology", "ologie",
  "Psychiatry", "Psychiatrie",
  "Transcultural", "Transculturelle",
  "Social", "Sociale",
  "Behavioral Science", "Sciences comportementales"
)

nice_entries(data, language = language, language_dictionary = edu_dictionary)
