...
```{r, results='asis'}
nice_header("Selected Leadership Experience", "Expériences de leadeurship sélectionnées", language)
```

```{r Leadership}

leadership_dictionary <- tribble(
  ~English, ~French,
  "Lead Student Ambassador \\\\& Co-founder, Student Ambassador Program",
    "Étudiant ambassadeur principal \\\\& Co-fondateur, Student Ambassador Program",
  "Lead of ~70 Ambassadors (blog, webinar, logo, Instagram, etc.), Editor-in-Chief (blog)",
    "Responsable d'environ 70 ambassadeurs (blogue, webinaire, logo, Instagram, etc.), rédacteur en chef (blogue)",
  "Member of think-tank for the future of positive psychology in Québec",
    "Membre du groupe de réflexion sur l'avenir de la psychologie positive au Québec",
  "Lead development of freshly formed student division, various responsabilities",
    "Diriger le développement d'une division étudiante nouvellement formée, diverses responsabilités",
  "Yoga \\\\& Meditation Student Committee Lead",
    "Co-responsable du comité étudiant de yoga et de méditation",
  "Led or organized meditation and yoga sessions, secured grants (\\\\$2198) for affordable classes",
    "Dirigé ou organisé des séances de méditation et de yoga, obtention de subventions pour le projet",
  "Regional Representative (for the province of Québec) of the Student Division (SIPPA)",
    "Représentant régional (pour la province du Québec) de la division étudiante (SIPPA)",
  ...
  "Quebec Positive Psychology Association",
    "Regroupement québécois de psychologie positive",
...
data <- rbind(
  ...
  #   when = "2009-04 – 2009-10, 2011-06, 2015-05",
...
data <- data %>% rename(with = role)
nice_entries(data, language, leadership_dictionary)
