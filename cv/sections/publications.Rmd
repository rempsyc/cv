...
```{r ScholarExcludePreview, echo = FALSE, results = "asis", eval = show_scholar_exclusion_preview}
preview_scholar_exclusions(
  data_scholar = data_scholar,
  scholar_exclude = scholar_exclude,
  n = scholar_exclusion_preview_n,
  order_by = "year",
  show_excluded = FALSE
)
```
...
data <- c(
  ...
  "Brodeur, A., Valenta, D., Marcoci, A., ... Thériault, R., et al. (2026). *AI-assisted teams outperform AI-led teams but not human-only teams in assessing research reproducibility in quantitative social science*. Accepted in *PNAS*. https://econpapers.repec.org/RePEc:zbw:i4rdps:195.",
  
  "Brodeur, A., Mikola, D., Cook, N., ... Thériault, R., et al. (2026). Reproducibility and robustness of economics and political science research. *Nature*, *652*, 151-156. https://doi.org/10.1038/s41586-026-10251-x",
