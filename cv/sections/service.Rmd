...
nice_header(
  header = "Academic Service & Leadership",
  header_alt = "Service académique et leadeurship",
  language = language
)
```
...
data <- bind_rows(
  ...
  tibble(
    ...
    details = italics(
      "Psychology of Consciousness: Theory, Research, and Practice, Group Processes and Intergroup Relations, \\\\ Journal of Statistical Software, Scientific Reports, International Journal of Mental Health Promotion, Discover Sustainability")
  ...
  tibble(
    what = "International Society of Hypnosis and the Québec Hypnosis Society",
