...
```{r Other experience parent, child=c('fr/sections/other_experience.Rmd'), eval = F}
```

```{r Leadership parent, child=c('fr/sections/leadership.Rmd'), eval = F}
```

```{r Varia parent, child=c('fr/sections/varia.Rmd'), eval = F}
```

```{r credit parent, child=c('fr/sections/credit.Rmd'), eval = F}
```
