...
# Expériences de leadeurship sélectionnées
...
data <- rbind(
  ...
  tibble(
    ...
    role = "Étudiant ambassadeur principal \\& Co-fondateur, Student Ambassador Program",
  ...
  tibble(
    ...
    role = "Co-responsable du comité étudiant de yoga et de méditation",
    where = "Montréal, Québec",
    details = c(
  ...
  tibble(
    ...
    role = "Représentant régional (pour la province du Québec) de la division étudiante (SIPPA)",
    where = "Montréal, Québec",
    details = c(
