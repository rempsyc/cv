...
Brodeur, A., Valenta, D., Marcoci, A., ... **Thériault, R.**, et al. (2025). *Comparing Human-Only, AI-Assisted, and AI-Led Teams on Assessing Research Reproducibility in Quantitative Social Science*. https://econpapers.repec.org/RePEc:zbw:i4rdps:195. En révision à la revue *Nature*.

Heyman, T., Pronizius, E., Lewis, S. C., ... **Thériault, R.**, et al. (2025). *Crowdsourcing Multiverse Analyses to Explore the Impact of Different Data-processing and Analysis Decisions: A Tutorial*. https://osf.io/fjhv5. En révision à la revue *Psychological Methods*.

Brodeur, A., Mikola, D., Cook, N., ... **Thériault, R.**, et al. (2024). *Mass Reproducibility and Replicability: A New Hope*. https://econpapers.repec.org/RePEc:zbw:i4rdps:107. Soumis à la revue *Science*.
