...
pubs <- c(
  "Buchanan, E. M., Cuccolo, K. M., Coles, N., ... Thériault, R., et al. (2025, sous presse). Measuring the semantic priming effect across many languages. Sous presse dans *Nature Human Behaviour*. https://doi.org/10.31219/osf.io/q4fjy",
  
  "Thériault, R. (2025). L’importance de la science ouverte en recherche en psychologie. *Fragments : Revue de psychologie*, 1-15. Preprint: https://doi.org/10.31234/osf.io/758dx",
  ...
  "Thériault, R. & Dandeneau, S. (2023). Implicitly activating mindfulness: Does trait self-control moderate its effect on aggressive behaviour? *Mindfulness*, 14(12), 2946–2962. Lauréat du Prix du meilleur article étudiant 2024 du Département de psychologie de l’UQAM. https://doi.org/10.1007/s12671-023-02246-w. Preprint: https://doi.org/10.21203/rs.3.rs-3161372/v2",
  ...
  "Thériault, R., Olson, J. A., Krol, S. A., & Raz, A. (2021). Body swapping with a Black person boosts empathy: Using virtual reality to embody another. *Quarterly Journal of Experimental Psychology*, 74(12), 2057-2074. Lauréat du Prix Relève étoile Paul‑Gérin‑Lajoie, pour meilleur article (FRQSC). https://doi.org/10.1177/17470218211024826",
...
number_pubs(pubs, author_bold = author_bold)
```
