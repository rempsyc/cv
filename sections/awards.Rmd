...
data <- rbind(
    ...
    tibble(
    Name = "Adrien-Pinard Psychology Award (PhD)",
    URL = "",
    Details = "",
    Date = "2024",
    Amount = 4000,
    ...
    tibble(
    Name = "Student Involvement Recognition Award (UQAM) - Personality 2nd and 3rd cycles",
    ...
    tibble(
    Name = "Student Involvement Recognition Award (UQAM) - Project, Health and healthy lifestyle component",
    URL = "https://actualites.uqam.ca/2023/bourses-implication-etudiante",
    Details = "Volet Santé et saines habitudes de vie - Programme des ambassadeurs étudiants de l'ACPP",
    Date = "2023",
    Amount = 1000,
    ...
    tibble(
    Name = "J.A. DeSève Foundation Award (PhD)",
