...
data <- rbind(
    ...
    tibble(
    Name = "Bourse Adrien-Pinard en psychologie - Doctorat ",
    URL = "",
    Details = "",
    Date = "2023",
    Amount = 4000,
    ...
    tibble(
    Name = "Prix reconnaissance de l’implication étudiante (UQAM) - Personnalités 2e et 3e cycles",
    ...
    tibble(
    Name = "Bourse de la Fondation J.A. DeSève - Doctorat",
    ...
    tibble(
    Name = "Bourse d'engagement du Syndicat des professeures et professeurs de l'UQAM (SPUQ) - Doctorat",
    URL = "https://www.spuq.uqam.ca/profil/bourses",
    ...
    tibble(
    Name = "Bourse Desjardins, catégorie Coup de pouce – Persévérance scolaire",
