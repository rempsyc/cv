...
data <- c(
  ...
  "Brodeur, A., Valenta, D., Marcoci, A., ... Thériault, R., et al. (2025). *Comparing Human-Only, AI-Assisted, and AI-Led Teams on Assessing Research Reproducibility in Quantitative Social Science*. https://econpapers.repec.org/RePEc:zbw:i4rdps:195." # Second round of review at *PNAS*. # Second round of review at *Nature*. # Deuxième ronde d'évaluation dans la revue *PNAS: The Proceedings of the National Academy of Sciences*. 
)
