...
pubs <- c(
  "Thériault, R. (2025). L’importance de la science ouverte en recherche en psychologie [The importance of open science in psychological research]. *Fragments : Revue de psychologie*, 1-15. Preprint: https://doi.org/10.31234/osf.io/758dx",
...
number_pubs(
  ...
  language = language, 
  language_dictionary = pubs_dictionary
)
```
