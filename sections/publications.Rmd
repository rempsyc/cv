...
data <- c(
  "Brodeur, A., Mikola, D., Cook, N., ... Thériault, R., et al. (In Press 2026). *Computational Reproducibility and Robustness of Empirical Economics and Political Science Research Between 2022 and 2023*. Accepted at *Nature*. https://econpapers.repec.org/RePEc:zbw:i4rdps:107.",
  
  "Pillai, R. M., Globig, L. K., Rathje, S., Sternisko, A., Thériault, R., & Van Bavel, J. J. (In Press 2026). *An identity-based approach to polarization and public health*. Accepted at *Social and Personality Psychology Compass*. https://doi.org/10.31234/osf.io/5z6r7_v1.",
