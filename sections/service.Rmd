...
data <- bind_rows(
  ...
  tibble(
    ...
    details = italics(
      "Psychology of Consciousness: Theory, Research, and Practice (7), Group Processes and Intergroup Relations (1), \\\\ Journal of Statistical Software (1), Scientific Reports (1), International Journal of Mental Health Promotion (1)")
    ),
