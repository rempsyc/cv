...
data <- rbind(
  ...
  tibble(
    Name = "CPA Annual National Convention",
    where = "Calgary, AB",
    Date = "2022/06"),  

  tibble(
    Name = "22e congrès de L’Association scientifique pour la modification du comportement",
    where = "Montréal, QC",
    Date = "2022/06"),
  
  tibble(
    Name = "Tenth SELF International Conference",
